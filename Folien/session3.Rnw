...
\textbf{Zeit}: 15 Minuten.
\end{frame}

\begin{frame}[t]{Politische Kultur}
\textbf{Wissenschaftliche Entwicklung}
\begin{itemize}
...
\textbf{Zusätzlicher Hintergrund}
\begin{itemize}
...
\begin{figure}[ht]
	...
	\caption{\textbf{Ideenboard aus einem Seminar}}
\end{figure}

\end{frame}

\begin{frame}[t]{Politische Kultur}
\textbf{Was ist politische Kultur?} \pause
\begin{itemize}
...
\textbf{4 political objects} \pause
\begin{itemize}
...
\textbf{Ausgangspunkt}: Unterschiedliche Entwicklungen in ehemals staatssozialistischen Ländern der EU (spätestens ab 2010)
...
\textbf{Frage}: Inwieweit geht unterschiedliche Entwicklung in den Staaten einher mit einer unterschiedlichen Entwicklung der politischen Kultur? \pause

\textbf{Vorgehensweise}: Vergleich politischer Kultur über Zeit über Länder
