...
Eine lineare Beziehung können wir über ein Scatterplot testen.
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=\textwidth]{figure/s10-1.png}
...
\begin{frame}{Grundlegende Mathematik in der linearen Regression}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=\textwidth]{figure/s10-2.png}
	    	\caption{\textbf{Lineare Relation}}
    	\end{figure}
    \end{column}
  \end{columns}
...
@
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=\textwidth]{figure/s10-3.png}
...
\begin{frame}{Bestimmtheitsmaß}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=\textwidth]{figure/s10-4.png}
...
\begin{frame}{Multivariate lineare Regression}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=.8\textwidth]{figure/s10-5.png}
...
\begin{frame}{Interpretation des Modells}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=.8\textwidth]{figure/s10-6.png}
	    	\caption{\textbf{Ergebnis multivariate lin. Regression}}
    	\end{figure}
    \end{column}
  \end{columns}
...
\begin{frame}{Interpretation}
    ...
    \begin{column}{.5\textwidth}
    	\begin{figure}[ht]
    		\includegraphics[width=.9\textwidth]{figure/s10-7.png}
	    	\caption{\textbf{Ergebnis multivariate lin. Regression}}
    	\end{figure}
    \end{column}
  \end{columns}
