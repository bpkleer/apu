...
setwd("C:/Users/g31442/Documents/JLUG/Lehre/21_22 WiSe/APU/Slides")
...
\textbf{Grundlagentexte}
	\begin{itemize}
		\item Easton, David (1975): A Re-Assessment of the Concept of Political Support, British Journal of Political Science, Vol 5, Nr. 4: 435-457.
		\item Fuhse, Jan (2005): Theorien des politischen Systems. David Easton und Niklas Luhmann. Eine Einführung. Wiesbaden: VS Verlag für Sozialwissenschaften. (S. 20-63)
...
\textbf{Zeit}: 15 Minuten; Präsentation in Plenum: 5 Minuten
	\begin{columns}
...
\begin{frame}{Wertemodell nach Schwartz (1992)}
	\begin{columns}
...
\textbf{Was sind Werte hier?} \\ \pause
...
\textbf{Entscheidungsträger:innen (authorities)} \\ \pause

„They must engage in the \textbf{daily affairs} of a political system; they must be \textbf{recognized by most members} of the system as \textbf{having the responsibility for these matters}; and \textbf{their actions must be accepted as binding} most of the time by most of the member \textbf{as long as they act within the limits of their roles}“ \parencite[212]{Easton1965} \\ \pause
...
„The regime as \textbf{sets of constraints on political interaction} in all systems may be broken down into three components: \textbf{values} (goals and principles), \textbf{norms}, and \textbf{structure of authority}.“ \parencite[193]{Easton1965}\\ \pause
...
\begin{frame}[t]{Objekte politischer Unterstützung}
\textbf{Politische Gemeinschaft (political community)} \\ \pause

„In confining the idea of political community in this way, I do so in order to focus (…) on the group of members who are drawn together by the fact that \textbf{they participate in a common structure and a set of processes}, however tight or loose the ties may be.“ \parencite[178]{Easton1965} \\ \pause
